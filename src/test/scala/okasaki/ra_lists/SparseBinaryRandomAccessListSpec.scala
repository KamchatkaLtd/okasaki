...
import okasaki.ra_list.SparseBinaryRandomAccessList
import okasaki.ra_list.SparseBinaryRandomAccessList._
 ...
 */
class SparseBinaryRandomAccessListSpec
  extends RandomAccessListSpec[Int, SRList[Int], SparseBinaryRandomAccessList[Int]](new SparseBinaryRandomAccessList[Int])
  with IntElements {
